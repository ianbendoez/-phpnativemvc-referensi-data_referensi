        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label>Kode</label>
              <select class="form-control select2" id="kriteria1" style="width: 100%;">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <div class="input-group">
                <input type="text" class="form-control" id="kriteria2" placeholder="Masukan kriterian pencarian...">
